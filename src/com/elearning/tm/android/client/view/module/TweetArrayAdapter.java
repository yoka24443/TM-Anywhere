...
//import com.elearning.tm.android.client.util.TextHelper;
//
//
//
...
//		View view;
//
//		SharedPreferences pref = TMApplication.mPref; // PreferenceManager.getDefaultSharedPreferences(mContext);
...
//		 * 添加特殊行的背景色
//		 */
//		if(holder.tweetUserText.getText().equals(TMApplication.getMyselfName())){
...
//		}else if(holder.tweetText.getText().toString().contains("@"+TMApplication.getMyselfName())){
